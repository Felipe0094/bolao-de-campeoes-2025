                      ...
                      <div className="flex items-center gap-6">
                        <div className="flex flex-col items-center gap-2 w-24">
                          <TeamLogo 
                            ...
                            size="md"
                          />
                          <span className="text-xs text-center font-medium line-clamp-2">{match.home_team.name}</span>
                        </div>
                        ...
                        <div className="flex flex-col items-center gap-2 w-24">
                          <TeamLogo 
                            ...
                            size="md"
                          />
                          <span className="text-xs text-center font-medium line-clamp-2">{match.away_team.name}</span>
                        </div>
                      </div>
